<div class="h-[45rem] flex flex-col justify-center overlay-y-scroll">
    ...
    @if (!$image)
        <div class="grow flex flex-col h-full items-center justify-center">
            ...
            <div class="text-center mb-5">
                ...
                <button class="bg-black text-white rounded py-2 px-3" onclick="document.getElementById('fileInput').click()">{{ __('Select from computer') }}</button>
